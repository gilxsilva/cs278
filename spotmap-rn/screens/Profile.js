      ...
      <View style={[styles.hero, { backgroundColor: t.bg }]}>
        ...
        <View style={[styles.statsRow, { backgroundColor: t.surface }]}>
          ...
          <View style={styles.stat}>
            ...
            <Text style={[styles.statLabel, { color: t.muted }]}>types</Text>
          </View>
          <View style={[styles.statDivider, { backgroundColor: t.border }]} />
          <View style={styles.stat}>
            ...
            <Text style={[styles.statLabel, { color: t.muted }]}>places</Text>
          </View>
        </View>
      </View>
      ...
      {uniqueCategories.length > 0 && (
        <View style={styles.catsUsed}>
          {uniqueCategories.map(id => {
            const c = getCat(id);
            return (
              <View key={id} style={[styles.catPill, { backgroundColor: c.color + '18' }]}>
                <Ionicons name={c.icon} size={10} color={c.color} />
                <Text style={[styles.catPillText, { color: c.color }]}>{c.label}</Text>
              </View>
            );
          })}
        </View>
...
const styles = StyleSheet.create({
  ...
  signOutBtn: { width: 34, height: 34, borderRadius: 17, alignItems: 'center', justifyContent: 'center' },
  ...
  statsRow: {
    ...
    borderRadius: 18, paddingVertical: 16, paddingHorizontal: 24, gap: 24,
  },
  ...
  pinCard: {
    ...
    shadowColor: '#1C1714', shadowOpacity: 0.06, shadowRadius: 8, shadowOffset: { width: 0, height: 2 },
    elevation: 1,
  },
